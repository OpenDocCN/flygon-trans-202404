...
如果你看`PlayerXToMove` case的最后一行，你可以看到全局的`uiState`字段被更新为新的游戏状态：
...
*注意：本文的代码在GitHub的[this gist](https://gist.github.com/swlaschin/3418b549bd222396da82)中可用。*
